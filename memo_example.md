...
Validate a document before you render it with `Test-QuillDocument -Quill usaf_memo -MarkdownPath .\memo_example.md`, which reports `IsValid` without writing a file. To generate many documents at once, pipe them through a single warm render host: `Get-ChildItem .\inbox\*.md | Export-QuillDocument -Quill usaf_memo -OutputDirectory .\out`.
